...
<AccordionGroup>
  ...
  <Accordion title="How is IFÁ Labs different from Chainlink or Pyth?">
    ...
    Many protocols use both: IFÁ Labs for stablecoin feeds, Chainlink or Pyth for volatile assets. See [Key Differentiators](/key-differentiators) for the full comparison.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Can I use IFÁ Labs from JavaScript without writing Solidity?">
    ...
    See [Get Your First Price](/get-your-first-price) for full off-chain examples in JavaScript, Python, and via Basescan.
  </Accordion>
</AccordionGroup>
