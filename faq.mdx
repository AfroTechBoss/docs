...
<AccordionGroup>
  ...
  <Accordion title="How do I read a price from IFÁ Labs in Sui Move?">
    ...
    The Feed Object ID on Sui Testnet is `0x9d5fc0fce3dc11efd95ef4b3218f3b45ff17012fbc629b35529f66833e46d91a`. Pass it as the `feed` argument in your transaction. See the [Sui Integration Guide](/sui-read-latest-price) for full examples.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Have the IFÁ Labs contracts been audited?">
    ...
    The Sui Move contracts are currently on testnet. A formal audit will be completed before Sui Mainnet deployment.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="What are the Sui Testnet object IDs?">
    ...
    When reading prices, pass the **Feed Object ID**. The Package ID is only needed when importing `ifa_oracle` as a dependency in your own Move package. See [Contract Addresses](/contract-addresses) for the full reference.
  </Accordion>
</AccordionGroup>
