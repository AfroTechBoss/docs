...
<AccordionGroup>
  <Accordion title="Have the IFÁ Labs contracts been audited?">
    ...
    The full audit summary is at [AdForensics Audit Summary](/security-and-audits/adforensics-audit-summary). The complete report is available on request from [support@ifalabs.com](mailto:support@ifalabs.com) and in the [GitHub repository](https://github.com/IFA-Labs/oracle_contract).
  </Accordion>
