---
title: "Supported assets full reference table"
description: "Complete reference table of every IFÁ Labs stablecoin price feed, with asset IDs, categories, per-network availability, and the process to request new feeds."
---
