...
The `Recommended MAX_PRICE_AGE` is 1.5× the heartbeat interval — the minimum safe staleness threshold accounting for heartbeat jitter. See [Update Triggers](/core-concepts/update-triggers-deviation-time) for a full explanation of the trigger model.
...
<CardGroup cols={2}>
  <Card title="Network Information" icon="network-wired" href="/reference/network-information">
