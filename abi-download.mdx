---
title: "ABI Download"
description: "Download the official IFÁ Labs oracle ABI JSON for use in smart contracts, ethers.js and web3.py scripts, subgraph indexers, and other developer tools."
---
...
<CardGroup cols={2}>
  <Card title="Security & Audits" icon="shield-check" href="/adforensics-audit-summary">
