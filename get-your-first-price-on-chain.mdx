...
description: "Quickstart guide to fetch a live stablecoin price from the IFÁ Labs oracle on-chain using Remix IDE, Basescan read functions, or a simple ethers.js script."
---
