...
description: "Quickstart: fetch a live stablecoin price from the IFÁ Labs oracle on Base in under five minutes using Remix IDE, Basescan, or a simple script."
---
