...
description: "Events emitted by the IFÁ Labs oracle smart contract for monitoring price updates, indexing in subgraphs, alerting, and building off-chain infrastructure."
---
