...
description: "Events emitted by the IFÁ Labs oracle contract — for monitoring, indexing, alerting, and building off-chain infrastructure."
---
...
<CardGroup cols={2}>
  <Card title="ABI Download" icon="download" href="/onchain-reference/smart-contracts/abi-download">
