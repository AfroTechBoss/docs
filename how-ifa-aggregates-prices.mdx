...
description: "A technical walkthrough of the IFÁ Labs price aggregation pipeline, from off-chain data collection and outlier rejection to on-chain submission."
---
