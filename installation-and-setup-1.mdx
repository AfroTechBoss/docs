---
title: "MCP Server installation and client setup"
description: "Install the IFÁ Labs MCP Server and connect it to Claude, Cursor, Windsurf, TRAE, and other MCP-compatible AI clients in a few minutes."
---
