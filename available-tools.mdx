...
description: "Complete reference for every tool exposed by the IFÁ Labs MCP Server, including input parameters, response formats, error behavior, and AI client usage notes."
---
