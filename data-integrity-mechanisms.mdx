...
<CardGroup cols={2}>
  <Card title="Verification Proofs" icon="magnifying-glass" href="/security-and-audits/verification-proofs">
    Tools and methods for independently verifying IFÁ Labs price accuracy.
  </Card>

  <Card title="AdForensics Audit Summary" icon="shield-check" href="/security-and-audits/adforensics-audit-summary">
