...
description: "When and why IFÁ Labs pushes price updates on-chain — the hybrid deviation and heartbeat model explained in full."
---
...
Protocols implementing peg deviation circuit breakers should check the price against the \$1.00 peg directly — not rely on the oracle's deviation trigger logic for that protection. See [Verify Price Integrity](/quickstart/verify-price-integrity) for circuit breaker implementation.
