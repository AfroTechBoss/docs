---
title: "Prerequisites"
description: "Everything you need before integrating IFÁ Labs price feeds — wallets, testnet ETH, and development tooling."
---
...
If you're already set up for EVM development on Base, you can skip straight to [Get Your First Price](/quickstart/get-your-first-price).
...
<CardGroup cols={2}>
  <Card title="Get Your First Price" icon="bolt" href="/quickstart/get-your-first-price">
