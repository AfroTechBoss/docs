---
title: "EVM smart contract installation and setup"
description: "Add IFÁ Labs oracle price feeds to your EVM smart contract project with interface installation, contract addresses, and initial Solidity configuration."
---
