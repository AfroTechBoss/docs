...
description: "Add IFÁ Labs to your EVM smart contract project — interface installation, contract addresses, and initial configuration."
---
...
<Warning>
  Always verify contract addresses against the [Contract Addresses](/onchain-reference/smart-contracts/contract-addresses) reference page and the verified source on Basescan before deploying to production. Never hardcode an address from an unofficial source.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Read Latest Price" icon="circle-dot" href="/integration-guides/evm-smart-contracts/read-latest-price">
