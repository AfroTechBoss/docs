...
New assets are added based on ecosystem demand. [Request a feed →](/support-and-community/get-help)
...
<CardGroup cols={2}>
  ...
  <Card title="Why Stablecoin Oracles?" icon="circle-question" href="/introduction/why-stablecoin-focused-oracles">
