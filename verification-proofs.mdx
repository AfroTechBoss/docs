...
description: "Tools, methods, and step-by-step processes for independently verifying IFÁ Labs price feed accuracy on-chain and off-chain without trusting IFÁ Labs itself."
---
...
<Steps>
  <Step title="Get the audited commit hash">
    The audited commit is documented in the [AdForensics Audit Summary](/adforensics-audit-summary):
